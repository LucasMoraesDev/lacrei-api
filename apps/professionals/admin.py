...
class ProfessionalAdmin(admin.ModelAdmin):
    list_display = ["social_name", "profession", "city", "state", "email", "is_active", "created_at"]
    ...
    fieldsets = (
        ("Identificação", {"fields": ("id", "social_name", "profession", "council_number", "is_active")}),
        ("Endereço", {"fields": ("street", "number", "complement", "neighborhood", "city", "state", "postal_code")}),
