...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        max_length=30,
                        verbose_name="número do conselho (CRM, CRP, etc.)",
                    ),
                ),
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                r"^[A-Z]{2}$", "Use a sigla do estado (ex.: SP)."
                            )
                        ],
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["profession", "is_active"], name="professiona_profess_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="professional",
            index=models.Index(
                fields=["city", "state"], name="professiona_city_st_idx"
            ),
        ),
    ]
